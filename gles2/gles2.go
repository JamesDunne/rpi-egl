...
func BlendFuncSeparate(srcRGB uint32, dstRGB uint32, srcAlpha uint32, dstAlpha uint32) {
	csrcRGB, _ := (C.GLenum)(srcRGB), cgoAllocsUnknown
	cdstRGB, _ := (C.GLenum)(dstRGB), cgoAllocsUnknown
	csrcAlpha, _ := (C.GLenum)(srcAlpha), cgoAllocsUnknown
	cdstAlpha, _ := (C.GLenum)(dstAlpha), cgoAllocsUnknown
	C.glBlendFuncSeparate(csrcRGB, cdstRGB, csrcAlpha, cdstAlpha)
}
...
func ShaderBinary(n int32, shaders []uint32, binaryformat uint32, binary unsafe.Pointer, length int32) {
	cn, _ := (C.GLsizei)(n), cgoAllocsUnknown
	cshaders, _ := (*C.GLuint)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&shaders)).Data)), cgoAllocsUnknown
	...
	C.glShaderBinary(cn, cshaders, cbinaryformat, cbinary, clength)
}
...
func StencilOpSeparate(face uint32, fail uint32, zfail uint32, zpass uint32) {
	cface, _ := (C.GLenum)(face), cgoAllocsUnknown
	cfail, _ := (C.GLenum)(fail), cgoAllocsUnknown
	czfail, _ := (C.GLenum)(zfail), cgoAllocsUnknown
	czpass, _ := (C.GLenum)(zpass), cgoAllocsUnknown
	C.glStencilOpSeparate(cface, cfail, czfail, czpass)
}
...
func VertexAttrib1f(indx uint32, x float32) {
	cindx, _ := (C.GLuint)(indx), cgoAllocsUnknown
	cx, _ := (C.GLfloat)(x), cgoAllocsUnknown
	C.glVertexAttrib1f(cindx, cx)
}

// VertexAttrib1fv function as declared in https://www.khronos.org/opengles/sdk/docs/man/xhtml/glVertexAttrib1fv.xml
func VertexAttrib1fv(indx uint32, values []float32) {
	cindx, _ := (C.GLuint)(indx), cgoAllocsUnknown
	cvalues, _ := (*C.GLfloat)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&values)).Data)), cgoAllocsUnknown
	C.glVertexAttrib1fv(cindx, cvalues)
}

// VertexAttrib2f function as declared in https://www.khronos.org/opengles/sdk/docs/man/xhtml/glVertexAttrib2f.xml
func VertexAttrib2f(indx uint32, x float32, y float32) {
	cindx, _ := (C.GLuint)(indx), cgoAllocsUnknown
	cx, _ := (C.GLfloat)(x), cgoAllocsUnknown
	cy, _ := (C.GLfloat)(y), cgoAllocsUnknown
	C.glVertexAttrib2f(cindx, cx, cy)
}

// VertexAttrib2fv function as declared in https://www.khronos.org/opengles/sdk/docs/man/xhtml/glVertexAttrib2fv.xml
func VertexAttrib2fv(indx uint32, values []float32) {
	cindx, _ := (C.GLuint)(indx), cgoAllocsUnknown
	cvalues, _ := (*C.GLfloat)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&values)).Data)), cgoAllocsUnknown
	C.glVertexAttrib2fv(cindx, cvalues)
}

// VertexAttrib3f function as declared in https://www.khronos.org/opengles/sdk/docs/man/xhtml/glVertexAttrib3f.xml
func VertexAttrib3f(indx uint32, x float32, y float32, z float32) {
	cindx, _ := (C.GLuint)(indx), cgoAllocsUnknown
	cx, _ := (C.GLfloat)(x), cgoAllocsUnknown
	cy, _ := (C.GLfloat)(y), cgoAllocsUnknown
	cz, _ := (C.GLfloat)(z), cgoAllocsUnknown
	C.glVertexAttrib3f(cindx, cx, cy, cz)
}

// VertexAttrib3fv function as declared in https://www.khronos.org/opengles/sdk/docs/man/xhtml/glVertexAttrib3fv.xml
func VertexAttrib3fv(indx uint32, values []float32) {
	cindx, _ := (C.GLuint)(indx), cgoAllocsUnknown
	cvalues, _ := (*C.GLfloat)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&values)).Data)), cgoAllocsUnknown
	C.glVertexAttrib3fv(cindx, cvalues)
}

// VertexAttrib4f function as declared in https://www.khronos.org/opengles/sdk/docs/man/xhtml/glVertexAttrib4f.xml
func VertexAttrib4f(indx uint32, x float32, y float32, z float32, w float32) {
	cindx, _ := (C.GLuint)(indx), cgoAllocsUnknown
	cx, _ := (C.GLfloat)(x), cgoAllocsUnknown
	cy, _ := (C.GLfloat)(y), cgoAllocsUnknown
	cz, _ := (C.GLfloat)(z), cgoAllocsUnknown
	cw, _ := (C.GLfloat)(w), cgoAllocsUnknown
	C.glVertexAttrib4f(cindx, cx, cy, cz, cw)
}

// VertexAttrib4fv function as declared in https://www.khronos.org/opengles/sdk/docs/man/xhtml/glVertexAttrib4fv.xml
func VertexAttrib4fv(indx uint32, values []float32) {
	cindx, _ := (C.GLuint)(indx), cgoAllocsUnknown
	cvalues, _ := (*C.GLfloat)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&values)).Data)), cgoAllocsUnknown
	C.glVertexAttrib4fv(cindx, cvalues)
}

// VertexAttribPointer function as declared in https://www.khronos.org/opengles/sdk/docs/man/xhtml/glVertexAttribPointer.xml
func VertexAttribPointer(indx uint32, size int32, kind uint32, normalized byte, stride int32, ptr unsafe.Pointer) {
	cindx, _ := (C.GLuint)(indx), cgoAllocsUnknown
	...
	C.glVertexAttribPointer(cindx, csize, ckind, cnormalized, cstride, cptr)
}
